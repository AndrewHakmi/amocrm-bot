...
JSON strings before being persisted::
    ...
    from sqlalchemy.enums import TypeDecorator, VARCHAR
    import json
...
to associate with enums. This method grabs the given type object or
...
The :meth:`.MutableBase.coerce` method is also supported on composite enums.
...
class Mutable(MutableBase):
    ...
    def associate_with(cls, sqltype: type) -> None:
        ...
        .. warning::
           ...
           :meth:`.associate_with` for enums that are permanent to an
           application, not with ad-hoc enums else this will cause unbounded
    ...
    def as_mutable(cls, sqltype: _TypeEngineArgument[_T]) -> TypeEngine[_T]:
        ...
        .. warning::
           ...
           The listeners established by this method are *global*
           to all mappers, and are *not* garbage collected.   Only use
           :meth:`.as_mutable` for enums that are permanent to an application,
           not with ad-hoc enums else this will cause unbounded growth
           in memory usage.
        ...
        def listen_for_type(
            ...
            for prop in mapper.column_attrs:
                if (
                    # all Mutable enums refer to a Column that's mapped,
