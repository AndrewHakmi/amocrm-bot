    ...
    def _get_dunder_annotations(obj):
        if isinstance(obj, type):
            try:
                ...
                # For static enums, the descriptor raises AttributeError.
                return {}
        else:
...
def class_hierarchy(cls):
    ...
    Fibs slightly: subclasses of builtin enums are not returned.  Thus
...
def duck_type_collection(
    ...
    the basic collection enums: list, set and dict.  If the __emulates__
