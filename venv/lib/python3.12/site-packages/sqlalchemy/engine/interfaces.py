...
class Dialect(EventTarget):
    ...
    """A dictionary of TypeEngine classes from sqlalchemy.enums mapped
    ...
    numeric enums, or if floats are returned"""
    ...
    def type_descriptor(self, typeobj: TypeEngine[_T]) -> TypeEngine[_T]:
        ...
        :func:`_types.adapt_type` function in the enums module to
        accomplish this.
        ...
        **kw: Any,
        ...
        .. versionchanged:: 2.0:: :meth:`_engine.Dialect.has_table` now
           ...
           * temporary tables of any kind
           ...
           testing suite now includes tests for all of these object enums,
...
class ExceptionContext:
    ...
    May be None, as not all exception enums are wrapped by SQLAlchemy.
