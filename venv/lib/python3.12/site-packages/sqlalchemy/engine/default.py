...
class DefaultDialect(Dialect):
    ...
    def type_descriptor(self, typeobj):
        ...
        the generic object which comes from the enums module.
...
class DefaultExecutionContext(ExecutionContext):
    ...
    def _execute_scalar(
        ...
        enums of statements individually or in the context of a parent INSERT
        or UPDATE statement.
    ...
    def _prepare_set_input_sizes(
        ...
        style of ``setinputsizes()`` on the cursor, using DB-API enums
