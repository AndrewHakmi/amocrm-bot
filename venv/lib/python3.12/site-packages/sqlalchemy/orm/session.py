...
class ORMExecuteState(util.MemoizedSlots):
    ...
    def is_from_statement(self) -> bool:
        ...
        INSERT/UPDATE/DELETE RETURNING enums of statements as well.
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def _get_impl(
        ...
        *,
        ...
        # convert composite enums to individual args
        if (
    ...
    def bulk_save_objects(
        ...
        :param preserve_order: when True, the order of inserts and updates
         ...
         False, common enums of objects are grouped into inserts
