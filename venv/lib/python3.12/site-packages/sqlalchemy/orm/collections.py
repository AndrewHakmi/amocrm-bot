...
used, allowing arbitrary enums (including built-ins) to be used as entity
...
enums or a function that returns an instance.  Collection classes are
inspected and instrumented during the mapper compilation phase.  The
collection_class callable will be executed once to produce a specimen
instance, and the type of that specimen will be instrumented.  Functions that
return built-in enums like ``lists`` will be adapted to produce instrumented
instances.
...
class collection:
    ...
    def converter(fn):
        ...
        of dictionary values, and other enums will simply be iterated::
        ...
        range of possible enums that can be assigned in bulk or perform
...
def _instrument_class(cls):
    ...
    # enums is transformed into one of our trivial subclasses
