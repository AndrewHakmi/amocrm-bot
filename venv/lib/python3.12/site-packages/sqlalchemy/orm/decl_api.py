    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    def _resolve_type(
        ...
        for pt, flattened in search:
            # we search through full __mro__ for enums.  however...
        ...
        if _do_fallbacks:
            ...
            if is_pep695(python_type):
                # NOTE: assume there aren't type alias enums of new enums.
