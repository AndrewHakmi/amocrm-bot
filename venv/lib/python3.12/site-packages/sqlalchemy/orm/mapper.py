...
class Mapper(
    ...
    def attrs(self) -> util.ReadOnlyProperties[MapperProperty[Any]]:
        ...
        of this attribute which limit the enums of properties
    ...
    def all_orm_descriptors(self) -> util.ReadOnlyProperties[InspectionAttr]:
        ...
        :class:`.QueryableAttribute`, as well as extension enums such as
        ...
        to a constant that distinguishes between different extension enums.
