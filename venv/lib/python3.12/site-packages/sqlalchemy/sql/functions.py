...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    meaning that type checkers and IDEs can be instructed on the enums to
    ...
    def within_group_type(
        ...
        """For enums that define their return type as based on the criteria
...
class _FunctionGenerator:
    ...
    :class:`~sqlalchemy.enums.Unicode` as the type:
...
class GenericFunction(Function[_T]):
    ...
    be available immediately::
        ...
        from sqlalchemy.enums import DateTime
