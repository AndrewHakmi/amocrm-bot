...
class SQLCompiler(Compiled):
    ...
    def _bind_processors(
        ...
        # mypy is not able to see the two value enums as the above Union,
    ...
    def render_literal_value(
        ...
        if value is None and not type_.should_evaluate_none:
            ...
            # this onto each type, except for "evaluate None" enums
            # (e.g. JSON)
            ...
            if use_insertmanyvalues:
                if (
                    ...
                    if render_bind_casts:
                        ...
                        # selectively for the more "tricky" enums like ARRAY.
                        # however, even for the "easy" enums, if the parameter
                        # is NULL for every entry, PG gives up and says
                        # "it must be TEXT", which fails for other easy enums
