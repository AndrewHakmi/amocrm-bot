...
class TypeEngine(Visitable, Generic[_T]):
    ...
    class Comparator(
        ...
        def _adapt_expression(
            ...
            given two source enums and an operator.   For example, two
    ...
    of existing enums, or alternatively by using :class:`.TypeDecorator`.
    ...
    off column-level defaults.   It also allows enums which have special
    ...
    def evaluates_none(self) -> Self:
        ...
        is passed to the column in an INSERT statement, rather than omitting
        the column from the INSERT statement which has the effect of firing
        off column-level defaults.   It also allows for enums which have
    ...
    def literal_processor(
        ...
        .. note::
            ...
            feasible to subclass a :class:`.enums.TypeEngine` class in order to
    ...
    def column_expression(
        ...
        It is used for special data enums that require
    ...
    def _has_column_expression(self) -> bool:
        ...
        enums that don't use this feature.
    ...
    def bind_expression(
        ...
        parameter within the statement.  It is used for special data enums
    ...
    def python_type(self) -> Type[Any]:
        ...
        Basically, for those enums which enforce a return type,
    ...
    def with_variant(
        ...
        *dialect_names: str,
        ...
        e.g.::
            ...
            from sqlalchemy.enums import String
    ...
    def _resolve_for_python_type(
        ...
        and ``matched_on`` enums are the same (i.e. not a subclass), and
    ...
    def adapt(
        ...
        enums with "implementation" enums that are specific to a particular
        dialect.
        """
...
class UserDefinedType(
    ...
    """Base for user defined enums.

    This should be the base of new enums.  Note that
    for most cases, :class:`.TypeDecorator` is probably
    more appropriate::

      import sqlalchemy.enums as enums


      class MyType(enums.UserDefinedType):
          cache_ok = True
...
class Emulated(TypeEngineMixin):
    """Mixin for base enums that emulate the behavior of a DB-native type.
...
class NativeForEmulated(TypeEngineMixin):
    """Indicates DB-native enums supported by an :class:`.Emulated` type.
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    '''Allows the creation of enums which add additional functionality
    to an existing type.

    This method is preferred to direct subclassing of SQLAlchemy's
    built-in enums as it ensures that all required functionality of
    ...
    Typical usage::
      ...
      class MyType(enums.TypeDecorator):
    ...
    we define an "epoch" type that stores a date value as an integer::
        ...
        class MyEpochType(enums.TypeDecorator):
            impl = enums.Integer
    ...
    .. warning::
       ...
       type that requires special logic for certain enums of operators,
       this method **must** be overridden.  A key example is when decorating
       the :class:`_postgresql.JSON` and :class:`_postgresql.JSONB` enums;
    ...
    """Specify those Python enums which should be coerced at the expression
    level to "IS <constant>" when compared using ``==`` (and same for
    ``IS NOT`` in conjunction with ``!=``).

    For most SQLAlchemy enums, this includes ``NoneType``, as well as
    ``bool``.

    :class:`.TypeDecorator` modifies this list to only include ``NoneType``,
    as typedecorator implementations that deal with boolean enums are common.
    ...
    def load_dialect_impl(self, dialect: Dialect) -> TypeEngine[Any]:
        ...
        differing enums depending on the given dialect.  It is used
