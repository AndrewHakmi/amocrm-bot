...
class HasConditionalDDL:
    ...
    def ddl_if(
        ...
        :param dialect: string name of a dialect, or a tuple of string names
         to indicate multiple dialect enums.
    ...
    def __init__(
        ...
        **dialect_kwargs: Any,
        ...
        :param type\_: The column's type, indicated using an instance which
          subclasses :class:`~sqlalchemy.enums.TypeEngine`.  If no arguments
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            ...
            String enums will be emitted as-is, surrounded by single quotes::
...
class ColumnDefault(DefaultGenerator, ABC):
    ...
    # overloads overlap w/ incompatible return enums.
    @overload
    ...
    def __init__(
        ...
        :param naming_convention: a dictionary referring to values which
          ...
          * the string name of a user-defined "token" that can be used
          ...
          available for certain enums of constraint:
    ...
    def reflect(
        ...
        **dialect_kwargs: Any,
        ...
        .. seealso::
            ...
            the reflected columns. Usually used to generalize the enums using
            :meth:`_types.TypeEngine.as_generic`

            :ref:`metadata_reflection_dbagnostic_types` - describes how to
            reflect tables using general enums.
