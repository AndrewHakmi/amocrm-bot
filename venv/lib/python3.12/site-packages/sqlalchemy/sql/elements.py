...
def literal(
    ...
    :param type\_: an optional :class:`~sqlalchemy.enums.TypeEngine` which will
...
def literal_column(
    ...
    :param type\_: an optional :class:`~sqlalchemy.enums.TypeEngine`
      object which will
...
class SQLCoreOperations(Generic[_T_co], ColumnOperators, TypingOnly):
    ...
    # redefined with the specific enums returned by ColumnElement hierarchies
    if typing.TYPE_CHECKING:
...
class TextClause(
    ...
    def bindparams(
        ...
        **names_to_values: Any,
        ...
        """Establish the values and/or enums of bound parameters within
        ...
        respectively.  The enums will be
    ...
    def columns(
        ...
        **types: _TypeEngineArgument[Any],
        ...
        This is often needed for enums such as date or boolean enums, as well
        ...
        enums alone may be used, if only type conversion is needed::
        ...
        :param \**enums: A mapping of string names to :class:`.TypeEngine`
