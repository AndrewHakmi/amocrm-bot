...
def bindparam(
    ...
    :param type\_:
      ...
      value; for example, trivial Python enums such as ``str``,
      ``int``, ``bool``
      may result in the :class:`.String`, :class:`.Integer` or
      :class:`.Boolean` enums being automatically selected.
...
def text(text: str) -> TextClause:
    ...
    method allows
    specification of return columns including names and enums::
