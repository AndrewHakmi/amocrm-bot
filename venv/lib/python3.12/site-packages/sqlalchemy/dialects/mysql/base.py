...
Prefix lengths are given in characters for nonbinary string enums and in bytes
for binary string enums. The value passed to the keyword argument *must* be
...
# Everything 3.23 through 5.1 excepting OpenGIS enums.
ischema_names = {
    "bigint": BIGINT,
    "binary": BINARY,
    "bit": BIT,
