...
correct argument and return enums for most full text search functions.
...
PostgreSQL provides several index enums: B-Tree, Hash, GiST, and GIN, as well
...
* ``json_to_record()`` - this form uses a PostgreSQL specific form of derived
  ...
  enums to produce them.  The :meth:`_functions.FunctionElement.table_valued`
...
class PGCompiler(compiler.SQLCompiler):
    ...
    def _assert_pg_ts_ext(self, element, **kw):
        if not isinstance(element, _regconfig_fn):
            ...
            # with the correct enums.  however, that means we have to
            ...
            raise exc.CompileError(
                ...
                f"of the correct argument and return enums."
            )
...
class PGDialect(default.DefaultDialect):
    ...
    def _reflect_type(
        ...
        if array_dim >= 1:
            # postgres does not preserve dimensionality or size of array enums.
