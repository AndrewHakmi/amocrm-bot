...
* the NVARCHAR2 and NCLOB datatypes are no longer generated as DDL when
  the :class:`~sqlalchemy.enums.Unicode` is used - VARCHAR2 and CLOB are issued
  instead. This because these enums don't seem to work correctly on Oracle 8
  even though they are available. The :class:`~sqlalchemy.enums.NVARCHAR` and
  :class:`~sqlalchemy.dialects.oracle.NCLOB` enums will always generate
  NVARCHAR2 and NCLOB.
...
one of these enums, use the :meth:`.TypeEngine.with_variant` method to set up a
variant::
        ...
        if _requires_binary_precision:
            ...
            if precision and binary_precision is None:
                ...
                raise exc.ArgumentError(
                    "Oracle Database FLOAT enums use 'binary precision', "
