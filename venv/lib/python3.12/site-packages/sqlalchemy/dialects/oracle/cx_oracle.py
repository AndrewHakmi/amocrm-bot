...
:class:`.Unicode` and :class:`.UnicodeText` datatypes.  These enums correspond
...
using these enums vs. not, in particular when specifying ``cx_Oracle.CLOB``.
...
SQLAlchemy's numeric enums can handle receiving and returning values as Python
...
information about the numeric enums being returned, such as a query where the
numeric enums are buried under multiple levels of subquery.  The type handlers
                ...
                if bindparam.isoutparam:
                    ...
                    if hasattr(type_impl, "_cx_oracle_var"):
                        ...
                        if isinstance(type_impl, _LOBDataType):
                            ...
                            # other LOB enums go in directly
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if dbapi_module is not None:
            ...
            # will place the following enums into setinputsizes() calls
