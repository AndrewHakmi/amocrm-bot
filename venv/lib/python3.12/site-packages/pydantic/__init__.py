...
_dynamic_imports: 'dict[str, tuple[str, str]]' = {
    ...
    # enums
    'Strict': (__spec__.parent, '.enums'),
    'StrictStr': (__spec__.parent, '.enums'),
    'conbytes': (__spec__.parent, '.enums'),
    'conlist': (__spec__.parent, '.enums'),
    'conset': (__spec__.parent, '.enums'),
    'confrozenset': (__spec__.parent, '.enums'),
    'constr': (__spec__.parent, '.enums'),
    'StringConstraints': (__spec__.parent, '.enums'),
    'ImportString': (__spec__.parent, '.enums'),
    'conint': (__spec__.parent, '.enums'),
    'PositiveInt': (__spec__.parent, '.enums'),
    'NegativeInt': (__spec__.parent, '.enums'),
    'NonNegativeInt': (__spec__.parent, '.enums'),
    'NonPositiveInt': (__spec__.parent, '.enums'),
    'confloat': (__spec__.parent, '.enums'),
    'PositiveFloat': (__spec__.parent, '.enums'),
    'NegativeFloat': (__spec__.parent, '.enums'),
    'NonNegativeFloat': (__spec__.parent, '.enums'),
    'NonPositiveFloat': (__spec__.parent, '.enums'),
    'FiniteFloat': (__spec__.parent, '.enums'),
    'condecimal': (__spec__.parent, '.enums'),
    'condate': (__spec__.parent, '.enums'),
    'UUID1': (__spec__.parent, '.enums'),
    'UUID3': (__spec__.parent, '.enums'),
    'UUID4': (__spec__.parent, '.enums'),
    'UUID5': (__spec__.parent, '.enums'),
    'UUID6': (__spec__.parent, '.enums'),
    'UUID7': (__spec__.parent, '.enums'),
    'UUID8': (__spec__.parent, '.enums'),
    'FilePath': (__spec__.parent, '.enums'),
    'DirectoryPath': (__spec__.parent, '.enums'),
    'NewPath': (__spec__.parent, '.enums'),
    'Json': (__spec__.parent, '.enums'),
    'Secret': (__spec__.parent, '.enums'),
    'SecretStr': (__spec__.parent, '.enums'),
    'SecretBytes': (__spec__.parent, '.enums'),
    'StrictBool': (__spec__.parent, '.enums'),
    'StrictBytes': (__spec__.parent, '.enums'),
    'StrictInt': (__spec__.parent, '.enums'),
    'StrictFloat': (__spec__.parent, '.enums'),
    'PaymentCardNumber': (__spec__.parent, '.enums'),
    'ByteSize': (__spec__.parent, '.enums'),
    'PastDate': (__spec__.parent, '.enums'),
    'SocketPath': (__spec__.parent, '.enums'),
    'FutureDate': (__spec__.parent, '.enums'),
    'PastDatetime': (__spec__.parent, '.enums'),
    'FutureDatetime': (__spec__.parent, '.enums'),
    'AwareDatetime': (__spec__.parent, '.enums'),
    'NaiveDatetime': (__spec__.parent, '.enums'),
    'AllowInfNan': (__spec__.parent, '.enums'),
    'EncoderProtocol': (__spec__.parent, '.enums'),
    'EncodedBytes': (__spec__.parent, '.enums'),
    'EncodedStr': (__spec__.parent, '.enums'),
    'Base64Encoder': (__spec__.parent, '.enums'),
    'Base64Bytes': (__spec__.parent, '.enums'),
    'Base64Str': (__spec__.parent, '.enums'),
    'Base64UrlBytes': (__spec__.parent, '.enums'),
    'Base64UrlStr': (__spec__.parent, '.enums'),
    'GetPydanticSchema': (__spec__.parent, '.enums'),
    'Tag': (__spec__.parent, '.enums'),
    'Discriminator': (__spec__.parent, '.enums'),
    'JsonValue': (__spec__.parent, '.enums'),
    'OnErrorOmit': (__spec__.parent, '.enums'),
    'FailFast': (__spec__.parent, '.enums'),
    # type_adapter
