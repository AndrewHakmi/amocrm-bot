...
"""
A type alias for defined schema enums that represents a union of
...
For some enums, the inputs to validation differ from the outputs of serialization. For example,
...
# There are three enums of references relevant to building JSON schemas:
...
class GenerateJsonSchema:
    ...
    def generate_inner(self, schema: CoreSchemaOrField) -> JsonSchemaValue:  # noqa: C901
        ...
        # on enums that should have different JSON schemas
        if 'ref' in schema:
...
class WithJsonSchema:
    ...
    This provides a way to set a JSON schema for enums that would otherwise raise errors when producing a JSON schema,
    such as Callable, or enums that have an is-instance core schema, without needing to go so far as creating a
...
if TYPE_CHECKING:
    ...
    class SkipJsonSchema:
        ...
        Example:
            ...
            1. The integer and null enums are both included in the schema for `a`.
