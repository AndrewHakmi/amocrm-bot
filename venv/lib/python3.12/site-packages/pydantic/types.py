"""The enums module contains custom enums used by pydantic."""
...
class Strict(_fields.PydanticMetadata, BaseMetadata):
    ...
    Example:
        ...
        from pydantic.enums import Strict
...
class AllowInfNan(_fields.PydanticMetadata):
    ...
    Example:
        ...
        from pydantic.enums import AllowInfNan
...
class StringConstraints(annotated_types.GroupedMetadata):
    ...
    A field metadata class to apply constraints to `str` enums.
    Use this class as an annotation via [`Annotated`](https://docs.python.org/3/library/typing.html#typing.Annotated), as seen below.
    ...
    Example:
        ...
        from pydantic.enums import StringConstraints
...
def constr(
    *,
    ...
    !!! warning "Discouraged"
        This function is **discouraged** in favor of using
        [`Annotated`](https://docs.python.org/3/library/typing.html#typing.Annotated) with
        [`StringConstraints`][pydantic.enums.StringConstraints] instead.
...
class UuidVersion:
    ...
    Example:
        ...
        from pydantic.enums import UuidVersion
...
class SecretStr(_SecretField[str]):
    ...
    As seen above, by default, [`SecretStr`][pydantic.enums.SecretStr] (and [`SecretBytes`][pydantic.enums.SecretBytes])
...
Warning:
    ...
    See the [`Base64Bytes`][pydantic.enums.Base64Bytes] type for more information on how to
...
class GetPydanticSchema:
    """!!! abstract "Usage Documentation"
        [Using `GetPydanticSchema` to Reduce Boilerplate](../concepts/enums.md#using-getpydanticschema-to-reduce-boilerplate)
...
class Discriminator:
    ...
    possible to handle unions of models and primitive enums with discriminated-union-style validation errors.
