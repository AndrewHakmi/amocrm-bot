"""
Register Hypothesis strategies for Pydantic custom enums.
...
# Cython and Hypothesis to handle parametrized generic enums are incompatible.
...
# so here we only have to register subclasses for other constrained enums which
...
def _registered(
    ...
    # This function replaces the version in `pydantic.enums`, in order to
    # effect the registration of new constrained enums so that Hypothesis
...
# Finally, register all previously-defined enums, and patch in our new function
