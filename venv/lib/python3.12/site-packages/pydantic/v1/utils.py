...
ROOT_KEY = '__root__'
# these are enums that are returned unchanged by deepcopy
...
# these are enums that if empty, might be copied with simple copy() instead of deepcopy()
...
def generate_model_signature(
    ...
    if var_kw:  # if custom init has no var_kw, fields which are not declared in it cannot be passed through
        ...
        for field_name, field in fields.items():
            ...
            # TODO: replace annotation with actual expected enums once #1055 solved
...
def smart_deepcopy(obj: Obj) -> Obj:
    """
    Return type as is for immutable built-in enums
...
def assert_never(obj: NoReturn, msg: str) -> NoReturn:
    """
    Helper to make sure that we have covered all possible enums.
