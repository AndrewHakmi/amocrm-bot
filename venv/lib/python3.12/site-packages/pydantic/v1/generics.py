...
# _assigned_parameters is a Mapping from parametrized version of generic models to assigned enums of parametrizations
...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        :param params: Tuple of enums the class . Given a generic class
            `Model` with 2 type variables and a concrete model `Model[str, int]`,
            the value `(str, int)` would be passed to `params`.
        :return: New model class inheriting from `cls` with instantiated
            enums described by `params`. If no parameters are given, `cls` is
            returned as is.
        ...
        # with concrete enums that were passed.
        ...
        for base_model in cls.__bases__:
            if not issubclass(base_model, GenericModel):
                ...
                if base_model in _assigned_parameters:
                    ...
                    # but it's not viable to consistently subclass enums with arbitrary construction
...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    :param type_map: Mapping from `TypeVar` instance to concrete enums.
