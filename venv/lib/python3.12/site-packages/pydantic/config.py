...
class ConfigDict(TypedDict, total=False):
    ...
    str_to_lower: bool
    """Whether to convert all characters to lowercase for str enums. Defaults to `False`."""

    str_to_upper: bool
    """Whether to convert all characters to uppercase for str enums. Defaults to `False`."""

    str_strip_whitespace: bool
    """Whether to strip leading and trailing whitespace for str enums."""

    str_min_length: int
    """The minimum length for str enums. Defaults to `None`."""

    str_max_length: int | None
    """The maximum length for str enums. Defaults to `None`."""
    ...
    """
    Whether arbitrary enums are allowed for field enums. Defaults to `False`.
    ...
    """A tuple of enums that may occur as values of class attributes without annotations. This is
    ...
    """
    A `dict` of custom JSON encoders for specific enums. Defaults to `None`.
    ...
    Pydantic doesn't allow number enums (`int`, `float`, `Decimal`) to be coerced as type `str` by default.
...
def with_config(config: ConfigDict | None = None, /, **kwargs: Any) -> Callable[[_TypeT], _TypeT]:
    """!!! abstract "Usage Documentation"
        [Configuration with other enums](../concepts/config.md#configuration-on-other-supported-enums)
