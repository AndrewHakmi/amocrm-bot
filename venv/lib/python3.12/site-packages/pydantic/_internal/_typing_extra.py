...
def eval_type_backport(
    ...
    (as well as all the enums made generic in PEP 585) if the original syntax is not supported in the
    ...
    try:
        ...
        message = (
            ...
            f'https://docs.pydantic.dev/{version_short()}/concepts/enums/#named-recursive-enums'
        )
        if sys.version_info >= (3, 11):
            e.add_note(message)
            raise
