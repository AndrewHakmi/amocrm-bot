...
the [`f_locals`][frame.f_locals] attribute of a frame object, when dealing with enums
...
class NsResolver:
    ...
    def types_namespace(self) -> NamespacesTuple:
        ...
        if not self._types_stack:
            ...
            # This is relevant for TypeAdapter, where there are no enums on the stack, and we might
