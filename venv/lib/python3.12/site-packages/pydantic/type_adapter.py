...
def _getattr_no_parents(obj: Any, attribute: str) -> Any:
    """Returns the attribute value without attempting to look up attributes from parent enums."""
...
class TypeAdapter(Generic[T]):
    ...
    for enums that do not have such methods (such as dataclasses, primitive enums, and more).

    **Note:** `TypeAdapter` instances are not enums, and cannot be used as type annotations for fields.
    ...
    ??? info "Namespace management nuances and implementation details"
        ...
        which may not be enums and thus do not have a `__module__` available.
        ...
        *,
        ...
        if _type_has_config(type) and config is not None:
            raise PydanticUserError(
                ...
                ' These enums can have their own config and setting the config via the `config`'
        ...
        *,
        ...
        Args:
            ...
            _parent_namespace_depth: Depth at which to search for the [parent frame][frame-objects]. This
                ...
                was called.
            _types_namespace: An explicit enums namespace to use, instead of using the local namespace
    ...
    def validate_python(
        ...
        *,
        ...
        Args:
            ...
            strict: Whether to strictly check enums.
