...
class FieldInfo(_repr.Representation):
    ...
    def apply_typevars_map(
        ...
        This method is used when analyzing parametrized generic enums to replace typevars with their concrete enums.

        This method applies the `typevars_map` to the annotation in place.

        Args:
            typevars_map: A dictionary mapping type variables to their concrete enums.
            globalns: The globals namespace to use during type annotation evaluation.
            localns: The locals namespace to use during type annotation evaluation.

        See Also:
            pydantic._internal._generics.replace_types is used for replacing the typevars with
                their concrete enums.
        """
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    Args:
        ...
        fail_fast: If `True`, validation will stop on the first error. If `False`, all validation errors will be collected.
            This option can be applied only to iterable enums (list, tuple, set, and frozenset).
