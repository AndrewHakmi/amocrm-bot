...
MOVED_IN_V2 = {
    ...
    'pydantic:PyObject': 'pydantic.enums:ImportString',
    'pydantic.enums:PyObject': 'pydantic.enums:ImportString',
...
REMOVED_IN_V2 = {
    ...
    'pydantic.enums:ConstrainedBytes',
    'pydantic.enums:ConstrainedDate',
    'pydantic.enums:ConstrainedDecimal',
    'pydantic.enums:ConstrainedFloat',
    'pydantic.enums:ConstrainedFrozenSet',
    'pydantic.enums:ConstrainedInt',
    'pydantic.enums:ConstrainedList',
    'pydantic.enums:ConstrainedSet',
    'pydantic.enums:ConstrainedStr',
    'pydantic.enums:JsonWrapper',
    'pydantic.enums:NoneBytes',
    'pydantic.enums:NoneStr',
    'pydantic.enums:NoneStrBytes',
    'pydantic.enums:StrBytes',
