...
class PydanticModelField:
    ...
    def expand_type(
        ...
        if self.type is not None and self.info.self_type is not None:
            ...
            # however this plugin is called very late, so all enums should be fully ready.
            # Also, it is tricky to avoid eager expansion of Self enums here (e.g. because
...
class PydanticModelTransformer:
    ...
    def collect_field_or_class_var_from_stmt(  # noqa C901
        ...
        if sym.type is None and node.is_final and node.is_inferred:
            ...
            # We do not support inferred enums in dataclasses, so we can try inferring
    ...
    def add_initializer(
        ...
        The added `__init__` will be annotated with enums vs. all `Any` depending on the plugin settings.
        """
            ...
            if sym_node is not None:
                ...
                if isinstance(var, Var):
                    ...
                    try:
                        ...
                        # This happens for PlaceholderNode; perhaps it will happen for other enums in the future..
                        var_str = repr(var)
    ...
    def get_config_update(self, name: str, arg: Expression, lax_extra: bool = False) -> ModelConfigData | None:
        ...
        if name == 'extra':
            if isinstance(arg, StrExpr):
                ...
                if not lax_extra:
                    # Only emit an error for other enums of `arg` (e.g., `NameExpr`, `ConditionalExpr`, etc.) when
                    ...
                    #
                    # It would be nice if we could introspect the enums better otherwise, but I don't know what the API
