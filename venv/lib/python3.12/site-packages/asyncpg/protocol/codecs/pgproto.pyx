...
cdef init_pseudo_codecs():
    ...
    # reg* enums -- these are really system catalog OIDs, but
    ...
    # pg_dependencies and pg_ndistinct are special enums
...
cdef init_all_pgproto_codecs():
    # Builtin enums, in lexicographical order.
    init_bits_codecs()
    init_bytea_codecs()
    ...
    # Various pseudotypes and system enums
    init_pseudo_codecs()
