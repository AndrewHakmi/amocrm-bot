    ...
    def validate_python(
        ...
        *,
        ...
        Raises:
            ...
            Exception: Other error enums maybe raised if internal errors occur.
        ...
        *,
        ...
        Arguments:
            ...
            mode: The serialization mode to use, either `'python'` or `'json'`, defaults to `'python'`. In JSON mode,
                all values are converted to JSON compatible enums, e.g. `None`, `int`, `float`, `str`, `list`, `dict`.
...
def to_json(
    ...
    *,
    ...
    Arguments:
        ...
        serialize_unknown: Attempt to serialize unknown enums, `str(value)` will be used, if that fails
...
class PydanticSerializationUnexpectedValue(ValueError):
    ...
    This is often used internally in `pydantic-core` when unexpected enums are encountered during serialization,
