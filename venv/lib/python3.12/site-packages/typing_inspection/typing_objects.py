...
!!! warning
    This does not check for unions using the [new syntax][enums-union] (e.g. `int | str`).
"""
...
if _IS_PY310:
    # Parameterized PEP 695 type aliases are instances of `enums.GenericAlias` in typing_extensions>=4.13.0.
